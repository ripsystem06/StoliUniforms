        ...
        <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
          ...
          <div className="flex flex-col items-center md:items-end gap-6">
            <div className="flex items-center gap-6">
              <a href="https://www.facebook.com/STOLIUNIFORMS" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 transition-colors hover:text-white">
                Facebook
              </a>
              <a href="https://www.instagram.com/stoliuniforms" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 transition-colors hover:text-white">
                Instagram
              </a>
            </div>
